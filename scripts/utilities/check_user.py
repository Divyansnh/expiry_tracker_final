...
with app.app_context():
    ...
    user = User.query.filter_by(username='Divyansh').first()
    ...
    if user:
        ...
        print("\nNo user found with username 'Divyansh'")
        
    # Also check by email in case username is different
    user_by_email = User.query.filter_by(email='Divyansh').first()
    if user_by_email:
        print(f"\nUser found by email:")
        ...
        print("\nNo user found with email 'Divyansh'") 